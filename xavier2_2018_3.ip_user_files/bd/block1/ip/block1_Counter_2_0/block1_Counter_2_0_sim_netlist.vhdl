...
--               C:/Users/Bradley/Documents/xavier/xavier2_2018_3/xavier2_2018_3.srcs/sources_1/bd/block1/ip/block1_Counter_2_0/block1_Counter_2_0_sim_netlist.vhdl
...
entity block1_Counter_2_0_Gray2Bin is
  port (
    bin : out STD_LOGIC_VECTOR ( 0 to 0 );
    vote : in STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of block1_Counter_2_0_Gray2Bin : entity is "Gray2Bin";
end block1_Counter_2_0_Gray2Bin;

architecture STRUCTURE of block1_Counter_2_0_Gray2Bin is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity block1_Counter_2_0_GrayCounter is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of block1_Counter_2_0_GrayCounter : entity is "GrayCounter";
end block1_Counter_2_0_GrayCounter;

architecture STRUCTURE of block1_Counter_2_0_GrayCounter is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity block1_Counter_2_0_Counter is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of block1_Counter_2_0_Counter : entity is "Counter";
end block1_Counter_2_0_Counter;

architecture STRUCTURE of block1_Counter_2_0_Counter is
...
g2b: entity work.block1_Counter_2_0_Gray2Bin
     port map (
      bin(0) => bin(1),
      vote(1 downto 0) => vote(2 downto 1)
    );
gctr: entity work.block1_Counter_2_0_GrayCounter
     port map (
...
entity block1_Counter_2_0 is
  ...
  attribute NotValidForBitStream of block1_Counter_2_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of block1_Counter_2_0 : entity is "block1_Counter_2_0,Counter,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of block1_Counter_2_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of block1_Counter_2_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of block1_Counter_2_0 : entity is "Counter,Vivado 2018.3";
end block1_Counter_2_0;

architecture STRUCTURE of block1_Counter_2_0 is
...
begin
inst: entity work.block1_Counter_2_0_Counter
     port map (
      clk => clk,
